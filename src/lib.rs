...
// Give generated code one stable path when the derive is expanded in another
// target belonging to this package (for example an integration test or
...
/// Implementation details used by code generated by `#[derive(Encodeable)]`.
///
/// This module is public because derive expansions are compiled in downstream
/// crates. It is not part of Minnow's user-facing API.
#[doc(hidden)]
pub mod __private {
    pub use bitstream_io::{BitRead, BitWrite};
}
